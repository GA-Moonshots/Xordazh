...
public class MecanumDrive extends SubsystemBase {
    ...
    public MecanumDrive(Xordazh robot, Pose2d startingPosition) {
        ...
        this.odometry = new HolonomicOdometry(
                this.leftFront.encoder.setDistancePerPulse(OdometryConfig.MM_PER_TICK)::getDistance,
                this.rightFront.encoder.setDistancePerPulse(OdometryConfig.MM_PER_TICK)::getDistance,
                this.leftBack.encoder.setDistancePerPulse(OdometryConfig.MM_PER_TICK)::getDistance,
                OdometryConfig.PARALLEL_DISTANCE, OdometryConfig.PERPENDICULAR_DISTANCE
        );
